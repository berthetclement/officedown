...
### Create a new Rmardown file

Open a new `Rmarkdown` file and choose `output: word_document`.  
  
Now replace the content in your new Rmakdown file (after first chunk) by the text below.  
  
As you can see, special character "*" or "1." with tabbed product shaping in you Word document output.  

the main interest is to no longer manage list styles in your Rmardown document and use your own custome list style in Word document output.  
...
In the new Rmardown file, use option `reference_docx`:  
...
Now you can save time and no longer worry about formatting lists in your Rmarkdown document, just use your "template".
